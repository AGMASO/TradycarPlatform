    ...
    <div className='flex flex-col sm:flex-row mt-10  p-3 min-h-[95vh]'>
      ...
      <div className='bg-gradient-to-bl from-gradient-1-start to-gradient-4-end rounded-[50px] w-[100%] sm:w-[50%] flex flex-col justify-center items-center p-5'>
        <p className='text-white text-[23px] p-2 sm:p-5 leading-2'>
          We have identified a major problem occurring in the second-hand
          market, FRAUD
          <br></br>
          <br></br>
          Several studies show that there is a high percentage of fraud, such as
          odometer manipulation, hiding past accidents, or replacement of
          official parts with counterfeit ones.
          <br></br>
          <br></br> We define TradyCar as a blockchain-based platform that could
          revolutionizes second-hand car transactions.
          <br></br>
          <br></br>
          How?, by leveraging NFTs to track and store transparent vehicle
          history data, empowering trustworthy transactions and creating a
