...
export default function RepairShopCheckNft(){
    ...
    const handleSubmit = async (e: any) =>{
        ...
        try {
            ...
            const message = isValidShop ? "Authorized RepairShop" : "Not authorized RepairShop";
              ...
              <div>
                <form onSubmit={handleSubmit} className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
                  ...
                  {isInvalidRepairShop === "Not authorized RepairShop" && (
                    <p className="text-red-500">You are not an Allowed Repair Shop</p>
                  )}
                  <div className="mb-4">
                  <label htmlFor="nftAddress" className="block text-gray-700 text-sm font-bold mb-2" >
                    NFT Address
                  </label>
                  <input
                    type="text"
                  ...
                  <button type="submit" className="bg-lila hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline">
                    Enter
                  </button>
                  </div>
