...
export default function BuyerOfferCardAccepted({id, price, buyer, offerIndex, nftAddress, tokenId, }) {
  ...
  return (
    <Card className="py-4 min-h-[30vh] w-[20vw]" key={id}>
      ...
      <small className="text-default-500 mt-[20px]">Price you need to pay</small>
      ...
      <CardFooter className="flex flex-row justify-evenly align-middle">
            ...
            <Button color="secondary" variant="ghost" onClick={handlePayment}>Process to pay</Button>
