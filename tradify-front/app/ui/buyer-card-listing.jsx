...
export default function BuyerCardListing({
  id,
  key,
  seller,
  carListingIndex,
  ...
  return (
    <Card className='py-4 min-h-[70vh]' key={carListingIndex}>
      <CardHeader className='pb-0 pt-2 px-4 flex-col items-start'>
        ...
        <p className='text-tiny uppercase font-bold text-indigo-600 pt-[5px] text-end'>
          <span className=' text-[8px]'>Owned by </span>{" "}
          {seller.slice(0, 5) + "..." + seller.slice(-5)}
        </p>
        <p className='text-tiny uppercase font-bold text-indigo-600 pt-[5px] text-end text-[8px]'>
          Token Id {tokenId}
        </p>
      </CardHeader>
              ...
              <form onSubmit={handleSubmit}>
                ...
                <ModalBody>
                  ...
                  <div className='flex py-2 px-1 justify-between'>
                    ...
                    >
                      I commit to paying the offered amount if the seller
                      accepts my offer
                    </Checkbox>
                  </div>
                </ModalBody>
